...
export default function FormularioEstoque() {
  const { form, produtos, handleChange, handleSubmit, handleCancel } = useFormularioEstoque();
  ...
  return (
    <div className="container mx-auto p-4 max-w-lg">
      <form onSubmit={handleSubmit} className="bg-white shadow-md rounded-lg p-8">
        ...
        <div className="mb-4">
          <label htmlFor="idProduto" className="block text-gray-700 font-medium">Produto</label>
          <select
            name="idProduto"
